...
The agent will automatically set up the environment, generate startup scripts, and launch PFC with pfc-server.

**Method 2: Manual %run**
```python
# In PFC GUI IPython console
%run "C:/path/to/toyoura-nagisa/services/pfc-server/start_server.py"
```
