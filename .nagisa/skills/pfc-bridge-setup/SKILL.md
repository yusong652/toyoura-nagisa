...
fish define _set_bridge_path
    global _pfc_bridge_path = '{nagisa_path}/pfc-mcp/pfc-bridge'
end
@_set_bridge_path
program call "{nagisa_path}/pfc-mcp/pfc-bridge/start_bridge.py"
```
...
```python
%run {nagisa_path}/pfc-mcp/pfc-bridge/start_bridge.py
```
