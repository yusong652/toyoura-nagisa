"""
Pydantic-related constants for Gemini API operations.

This module contains constants related to Pydantic model handling,
primarily used for filtering model metadata attributes to avoid deprecation warnings.
"""
