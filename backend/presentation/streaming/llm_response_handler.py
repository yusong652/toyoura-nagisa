...
async def process_post_pipeline(
    ...
    try:
        ...
        # Use ContentService for title generation logic
        ...
        if content_service.should_generate_title(session_id, history_msgs):
            result = await content_service.generate_title_for_session(session_id, llm_client)
