...
def build_google_contacts_service(email, tokens_dir=None):
    """
    Initialize and return a Google Contacts API service using OAuth2 credentials for the given email.
    Args:
        email: The Google account email address (str)
        tokens_dir: Optional, path to the tokens directory
    Returns:
        Google Contacts API service object
    Raises:
