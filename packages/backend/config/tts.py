...
class GPTSoVITSConfig(BaseSettings):
    ...
    # 服务器配置
    gpt_sovits_server_url: str = Field(default="http://localhost:9880", description="GPT-SoVITS服务器URL", validation_alias="GPT_SOVITS_SERVER_URL")
    ...
    prompt_text: str = Field(default="嗯～～ ", description="提示文本")
...
class TTSSettings(BaseSettings):
    ...
    def get_fish_audio_config(self) -> FishAudioConfig:
        """获取Fish Audio配置"""
        return FishAudioConfig() # type: ignore
