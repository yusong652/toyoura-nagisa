...
class AppSettings(BaseSettings):
    ...
    model_config = SettingsConfigDict(
        env_file=".env", env_file_encoding="utf-8", case_sensitive=False, env_prefix="APP_", extra="ignore"
    )
...
def get_system_prompt(agent_name: str = "pfc_expert") -> str:
    """
    ...
    Args:
        agent_name: Agent name ("pfc_expert", "pfc_explorer", "pfc_diagnostic")
    """
    # Reserved for future agent-specific prompt selection
    _ = agent_name
