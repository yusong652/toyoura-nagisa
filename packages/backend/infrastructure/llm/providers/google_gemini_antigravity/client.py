"""
Google Gemini Antigravity client.
...
class GoogleGeminiAntigravityClient(LLMClientBase):
    """
    Gemini Antigravity OAuth client using Code Assist endpoints with fallback.
    ...
    def _debug_enabled(self) -> bool:
        env_flag = os.getenv("GEMINI_ANTIGRAVITY_DEBUG") or os.getenv("GEMINI_CLI_DEBUG")
        if env_flag:
