 ...
 * Reference: Gemini CLI components/shared/VirtualizedList.tsx
 *
 * A virtualized list that only renders visible items for performance.
 * Supports scrolling, auto-scroll to bottom on new items, and proper
 * height measurement.
 */
...
function VirtualizedList<T>(
  ...
  // Measure container and items on every render
  useLayoutEffect(() => {
  ...
  // Track previous state for auto-scroll
  ...
  useLayoutEffect(() => {
    ...
    // Scroll to end if list grew and we were at bottom
    if (
